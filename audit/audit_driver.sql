-- Tabla auditora para Driver usando JSONB
CREATE TABLE audit_driver (
...
-- Función para registrar auditoría en Driver
CREATE OR REPLACE FUNCTION log_driver_changes()
RETURNS TRIGGER AS $$
BEGIN
    IF (TG_OP = 'INSERT') THEN
        INSERT INTO audit_driver (
...
-- Trigger para auditar la tabla Driver
CREATE TRIGGER trg_audit_driver
