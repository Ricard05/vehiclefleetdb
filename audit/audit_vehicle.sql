-- Tabla auditora para Vehicle usando JSONB
...
-- Función para registrar auditoría en Vehicle
CREATE OR REPLACE FUNCTION log_vehicle_changes()
RETURNS TRIGGER AS $$
BEGIN
    IF (TG_OP = 'INSERT') THEN
        INSERT INTO audit_vehicle (
...
-- Trigger para auditar la tabla Vehicle
CREATE TRIGGER trg_audit_vehicle
